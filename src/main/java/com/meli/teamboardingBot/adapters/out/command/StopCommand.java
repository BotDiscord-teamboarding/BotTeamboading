...
public class StopCommand implements SlashCommandHandler {
    ...
    public StopCommand(GetOrCreateFormStatePort getOrCreateFormStatePort, GetFormStatePort getFormStatePort, DeleteFormStatePort deleteFormStatePort, MessageSource messageSource) {
