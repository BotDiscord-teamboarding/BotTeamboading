package com.meli.teamboardingBot.adapters.out.client.constants;
public final class ApiEndpoints {
    private ApiEndpoints() {}
    public static final String SQUAD_BASE = "/clients/squads";
    ...
    public static final String SQUAD_LOG_LIST_ALL = "/clients/squad_logs?offset=0&limit=15";
    ...
    public static String buildSquadLogListUrl(int offset, int limit) {
        return "/clients/squad_logs?offset=" + offset + "&limit=" + limit;
    }
}
